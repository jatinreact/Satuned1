...
function BrandList(props) {
  ...
  const [BrandListArry, setBrandListArry] = useState([]);
  ...
  const UpdateBrand = (ID) => {
    let id = ID;
    setisloading(true);
    let url = getBaseUrl() + `updateBrand/${id}`;
    let temp = {
  ...
  const filterData = BrandListArry.filter((event) => {
    return (
      event.brandName.toLowerCase().indexOf(titlename.toLowerCase()) !== -1
    );
  });
      ...
      <div className="home_padding">
        <div className="content_padding">
          <Grid className="Component_main_grid mb-3">
            <Grid item md={9}>
              <h3 className="mb-2">Car Brands</h3>
              <button
                type="button"
                class="btn btn-info mr-4"
                onClick={() => props.history.push("/brandsCreate")}
              >
          ...
          <Card classname="main_card p-3">
            <TableContainer>
              <Table className={classes.table} aria-label="simple table">
                <TableHead>
                  <TableRow>
                    <TableCell>Car Brands Name</TableCell>{" "}
                    ...
                    <TableRow key={row.name}>
                      ...
                      <TableCell>
                        ...
                        <span
                          ...
                          onClick={() =>
                            props.history.push("/series-list", { data: row })
                          }
                        >
                          Add Series
                        </span>
